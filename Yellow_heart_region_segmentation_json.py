...
# ---------------------- 配置项（根据实际修改） ----------------------
INPUT_DIR = r"./data/annotations_head_region" # 图片+JSON所在文件夹
OUTPUT_DIR = r"./data/Auto_segment_Yellow_heart/Visualization"  # 可视化结果保存文件夹
JSON_OUTPUT_DIR = r"./data/Auto_segment_Yellow_heart/json"  # JSON文件保存文件夹
