...
# ---------------------- 核心配置 ----------------------
# 标注 JSON 和图像所在的文件夹路径
INPUT_FOLDER = r"ChineseCabbage-YellowHeart-Phenotyping\samples_images\Data\json"
# 最终结果输出路径
OUTPUT_XLSX = os.path.join(INPUT_FOLDER, "roi_10_color_features_with_ratio_100.xlsx")
